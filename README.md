...
2. **CSV-Datei Orders von Etsy herunterladen:** Laden Sie aus Shop Manager > Einstellungen > Optionen die Orders für die Monate herunter und stellen Sie sicher, dass alle mit `EtsySoldOrders` im Namen beginnen.
